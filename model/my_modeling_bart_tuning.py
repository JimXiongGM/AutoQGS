...
"""PyTorch BART model.  Version: 4.12.2"""
import copy
import math
import random
import warnings
...
class BartAttention(nn.Module):
    ...
    def forward(
        ...
        # get query proj. hidden_states: [bsz, tgt_len, hid]
...
class BartModel(BartPretrainedModel):
    ...
    def forward(
        ...
        decoder_outputs = self.decoder(
            input_ids=decoder_input_ids,  # train: 带有start的完整idx. pred:
...
class BartForConditionalGeneration(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig):
        ...
        # my linear
        self.tuning_head = nn.Linear(config.d_model, config.d_model, bias=False)
    ...
    def forward(
        ...
        tmp = self.tuning_head(outputs[0])
        lm_logits = self.lm_head(tmp) + self.final_logits_bias
