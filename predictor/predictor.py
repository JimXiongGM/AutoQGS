...
class Seq2SeqPredictor(Predictor):
    """
    Predictor for sequence to sequence models
    """

    def predict(self, sub_type_name, predicate_text, obj_des, **kwargs) -> JsonDict:
        pass
    ...
    def _json_to_instance(self, json_dict: JsonDict) -> Instance:
        ...
        """
        source = self._dataset_reader.process_source(**json_dict)
